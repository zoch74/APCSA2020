...
public class StartPanel extends JPanel
{
	...
	/**
	 * String to populate the clueLabel if Athlete Celebrity is picked.
	 */
	...
	public StartPanel(CelebrityGame controller)
	{
		...
		this.athleteClue = "Enter the clues for the athlete celeb with at least 15 characters";
		this.clueLabel = new JLabel(celebrityClue);
		
		this.answerField = new JTextField("Type celebrity here (4 letters minimum thx Cher)");
		this.clueField = new JTextField("Enter celebrity clue here");
